  ...
  <section>
    <base-card>
      ...
      <ul v-else-if="hasItems">
        <grocery-item v-for="item in allItems" :key="item.id" :id="item.id" :itemName="item.itemName" :rate="item.rate"
          :quantity="item.quantity" :category="item.category"></grocery-item>
      </ul>
